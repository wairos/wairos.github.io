...
<html>
  <body>
   ...
   <div class="container calendarWidth">
     <h3 class="text-center pink">Weekly Rates</h3>
     <div class="row">
   <ul class="col-xs-6 text-right" style="list-style:none;">
     <li class="row">6 Weeks to 3 Years</li>
     <li class="row">3 Years to 5 Years</li>
     <li class="row">School Age </li>
     <li class="row">School Age</li>
   </ul>
   <ul class="col-xs-6" style="list-style:none;">
     <li>$95</li>
     <li>$80</li>
     <li>(Before & After Care) $50</li>
     <li>(Summer Program) $65</li>
   </ul>
 </div>

 </div>
 <h3 class="text-center pink">One-Time Fees</h3>
 <div class="row">
<ul class="col-xs-6 text-right" style="list-style:none;">
 <li class="row">Registration Fee</li>
 <li class="row">Summer Swim Fee (School Age)</li>
</ul>
<ul class="col-xs-6" style="list-style:none;">
 <li>$25</li>
 <li>$45</li>
