...
<!-- HOURS OF OPERATION -->
    ...
    <h2 class="darkGreen">Hours of Operation</h2>
    <p><span class="pink">Open</span>: Weekdays<br>6:00 a.m. - 6:00 p.m.<br><span class="pink">Closed</span>: Weekends, Thanksgiving Day, Christmas Day, and New Year's Day.</p>
  <!-- CONTACT INFO -->
    <hr>
